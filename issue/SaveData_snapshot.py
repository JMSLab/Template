# Snapshot of source/lib/SaveData.py as of 2026-06-02.
# The repro script imports this copy so it keeps demonstrating the old behavior
# after the library implementation is fixed upstream.
